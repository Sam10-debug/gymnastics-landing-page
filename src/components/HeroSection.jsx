  ...
  return (
		<section className=" flex flex-col-reverse md:flex-row h-screen ">
			<div className="flex-1 relative flex flex-col justify-center items-start mt-4 md:mt-0">
				<h1 className="text-3xl px-1 md:px-0 text-white font-bold text-center md:text-left ">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Exercitationem, sequi!</h1>
				<div className="py-4 mx-auto md:mx-0">
					<button className="w-[150px] h-[40px] border-[2px] mr-2 font-semibold hero-btn">jhjstsjays</button>
					<button className="w-[150px] h-[40px] border-[2px] font-semibold hero-btn">jhjstsjaysksya</button>
				</div>
